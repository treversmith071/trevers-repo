...
if [ -n "$used" ]; then
  ...
  printf "\033[94m%s\033[0m\033[2m  [\033[94m%s\033[0m\033[2m] \033[38;5;120m%d%% used\033[0m\033[2m%s%s\033[0m" \
...
if [ -n "$USAGE_PCT" ]; then
  ...
  printf "\033[95m5hr limit\033[0m\033[2m${_pad}[\033[95m%s\033[0m\033[2m] \033[38;5;120m%d%%%s\033[0m" \
